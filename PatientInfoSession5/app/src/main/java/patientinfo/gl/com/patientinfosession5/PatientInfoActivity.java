...
TextView tvValue;
    ...
    public  void buttonListView(){
        butListView=findViewById(R.id.buttoListView);
        butListView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public  void buttonBasic(){
        butBasic=findViewById(R.id.buttobasic);
        butBasic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),BasicEventActivity.class);
                startActivity(intent);
            }
        });
    }
