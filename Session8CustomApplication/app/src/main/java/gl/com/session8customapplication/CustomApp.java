...
public class CustomApp extends Application {
    ...
    public void onCreate() {
        ...
        model.setName("Ankita");
        model.setSurname("Tiwari");
        model.setCity("Nagpur");
        model.setEducation("BE");
        modelList.add(model);
        Log.d("oncreateCustomApp","oncreateCustomApp");
        Log.d("Name",model.getName());
        Log.d("Surname",model.getSurname());
        Log.d("City",model.getCity());
        Log.d("Education",model.getEducation());

        Log.d("modelList", String.valueOf(modelList.toString()));
